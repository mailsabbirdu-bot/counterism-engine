    ...
    def gemini_change(self, scene_num: int, scene: Dict[str, Any]):
        ...
        for attempt in range(3):
            ...
            refine_prompt = (
                ...
                "2. VISUAL HIERARCHY: 1 Primary focal element (hub_network, flow_diagram, or large chart). Supporting indicators (kpi_card, tech_badge) follow.\n"
                "3. PROGRESSIVE STORYTELLING: Wave Reveal timing. Wave 1 (15f): Title. Wave 2 (45f): Primary Graphic. Wave 3 (75f): Details.\n"
                "4. DATA INTEGRITY: Use REAL NUMBERS from narration. NO placeholders.\n"
                "5. INFOGRAPHIC SYSTEMS: Use 'infographic_lines' and 'groups' to build connected procedural systems.\n"
                "6. TYPOGRAPHIC HIERARCHY: Content 3-5 words max. Every text overlay MUST have 'hero_config'.\n"
                "7. CAMERA INTELLIGENCE: Rotate shots: rack_focus, cinematic_drift, pan_right, orbit. Target different overlays.\n"
                "\nVISUALS:\n"
                ...
                "\nTASK: OUTPUT UPDATED RAW JSON BLOCK NOW. NO CHATTER. NO PREAMBLE."
            )
